...
<body>
	...
	<br />
	<div id="section">
		<form action="exclivro" method="post">
			...
			<table>
				...
				<tr>
					<td>Sinopse:</td>
					<td><textarea name="sinopse" rows="10" cols="61" readonly></textarea></td>
				</tr>
				<tr>
					<td>Idioma:</td>
					<td><input type="text" name="txtIdioma" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Origem:</td>
					<td><input type="text" name="txtOrigem" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Isbn:</td>
					<td><input type="text" name="txtIsbn" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Autor:</td>
					<td><input type="text" name="txtAutor" size="80" readonly/></td>
				</tr>
				<tr>
					<td>Editora:</td>
					<td><input type="text" name="txtEditora" size="80" readonly/></td>

				</tr>
				<tr>
					<td>Categoria:</td>
					<td><input type="text" name="txtCategoria" size="80" readonly/></td>

				</tr>
				<tr>
					<td>Preço:</td>
					<td><input type="text" name="txtPreco" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Altura:</td>
					<td><input type="text" name="txtAltura" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Largura:</td>
					<td><input type="text" name="txtLargura" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Comprimento:</td>
					<td><input type="text" name="txtComprimento" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Preço desconto:</td>
					<td><input type="text" name="txtPrecoDesconto" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Ano:</td>
					<td><input type="text" name="txtAno" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Páginas:</td>
					<td><input type="text" name="txtPaginas" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Estoque:</td>
					<td><input type="text" name="txtEstoque" size="23" readonly/></td>
				</tr>
				<tr>
					<td>Porcentagem desconto:</td>
					<td><input type="text" name="txtPorcDesc" size="23" readonly/></td>
				</tr>
				<tr>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" style="text-align: right;"><input type="image" src="/Nac_Livraria/imagens/excluir.jpg" title="Excluir Livro"></td>
				</tr>
			</table>
		</form>
	</div>
