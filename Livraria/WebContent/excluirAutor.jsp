...
<body>
	...
	<br />
	<div id="section">
		<form action="excautor" method="post">
			...
			<table>
				<tr>
					...
					<td><input type="text" name="txtDataNasc" size="23" /></td>
				</tr>
				<tr>
					<td>Nacionalidade:</td>
				...
				<tr>
					<td>Início Atividade:</td>
					<td><input type="text" name="txtInicAtv" size="23" /></td>
				</tr>
				<tr>
					<td>Naturalidade:</td>
					<td><input type="text" name="txtNaturalidade" size="50" /></td>
				</tr>
				<tr>
					<td>Ocupação:</td>
					<td><input type="text" name="txtOcupacao" size="80" /></td>
				</tr>
				<tr>
					<td>Movimento:</td>
					<td><input type="text" name="txtMovimento" size="80" /></td>
				</tr>
				<tr>
					<td>Influência:</td>
					<td><input type="text" name="txtInfluencia" size="50" /></td>
				</tr>
				<tr>
					<td>Religião:</td>
					<td><input type="text" name="txtReligiao" size="50" /></td>
				</tr>
				<tr>
					<td>Etnia:</td>
					<td><input type="text" name="txtEtnia" size="50" /></td>
				</tr>
				<tr>
					<td>Fim Atividade:</td>
					<td><input type="text" name="txtFimAtv" size="23" /></td>
				</tr>
				...
				<tr>
					<td colspan="2" style="text-align: right;"><input type="image" src="/Nac_Livraria/imagens/excluir.jpg" title="Editar Autor"></td>
				</tr>
			</table>
		</form>
	</div>
