...
<body>
	...
	<br />
	<div id="section">
		<form action="cadeditora" method="post">
			...
			<table>
				...
				<tr>
					<td colspan="2" style="text-align: right;"><input type="image"
						src="/Nac_Livraria/imagens/cadastrar.jpg" title="Cadastrar Editora"></td>
				</tr>
